  ...
  return (
    <div className="App">
      ...
      <div className='form-clientes'>
        ...
        <ul>{clientes.map(c=><li key={c.id_cliente}>{c.id_cliente} - {c.nombre} - {c.telefono} - {c.email} <button onClick={()=>deleteCliente(c.id_cliente)}>Eliminar 🗑️</button></li>)}</ul>
      </div>
      ...
      <div className='form-empleados'>
        ...
        <ul>{empleados.map(e=><li key={e.id_empleado}>{e.id_empleado} - {e.nombre} - {e.cargo} - {e.salario} <button onClick={()=>deleteEmpleado(e.id_empleado)}>Eliminar 🗑️</button></li>)}</ul>
      </div>
      ...
      <div className='form-productos'>
        ...
        <ul>{productos.map(p=><li key={p.id_producto}>{p.id_producto} - {p.nombre} - {p.precio} - {p.categoria} <button onClick={()=>deleteProducto(p.id_producto)}>Eliminar 🗑️</button></li>)}</ul>
      </div>
      ...
      <div className='form-pagos'>
        ...
        <ul>{pagos.map(p=><li key={p.id_pago}>{p.id_pago} - {p.tipo} <button onClick={()=>deletePago(p.id_pago)}>Eliminar 🗑️</button></li>)}</ul>
      </div>
      ...
      <div className='form-pedidos'>
        ...
        <ul>{pedidos.map(p=><li key={p.id_pedido}>{p.id_pedido} - {p.id_cliente} - {p.id_empleado} - {p.fecha} - {p.id_pago} <button onClick={()=>deletePedido(p.id_pedido)}>Eliminar 🗑️</button></li>)}</ul>
      </div>
      ...
      <div className='form-detalle'>
        ...
        <ul>{detallePedidos.map(d=><li key={d.id_detalle}>{d.id_detalle} - {d.id_pedido} - {d.id_producto} - {d.cantidad} - {d.subtotal} <button onClick={()=>deleteDetalle(d.id_detalle)}>Eliminar 🗑️</button></li>)}</ul>
      </div>
